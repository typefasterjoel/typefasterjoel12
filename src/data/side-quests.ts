...
const allSideQuests: SideQuest[] = [
	...
	// ── Yumu (draft) ──────────────────────────────────────────────────────
	// TODO(joel): write the real blurb/links, and drop a real screenshot into
	// /public/work/yumu/thumb.svg, then flip `draft` off.
	{
		slug: "yumu",
		title: "Yumu",
		draft: true,
		blurb: "TODO(joel): 1-3 sentences on what Yumu adds to YouTube Music.",
		tags: ["TODO(joel)"],
		thumbnail: {
			src: "/work/yumu/thumb.svg",
			alt: "TODO(joel): describe the screenshot",
			width: 800,
			height: 500,
		},
