      ...
      <div className="about-prose">
        ...
        <Reveal delay={0.14}>
          <p className="body-lg about-body">
            Boricua, <em>pa' que tu lo sepas</em>. I've spent {EXPERIENCE_LABEL}{" "}
            years at the seam between design and engineering: building design
            systems, shipping product surfaces, and caring deeply about the
        ...
        <Reveal delay={0.2}>
          <p className="body about-body">
            ...
            actual patients, then joining Linux Academy when it had 20 people
            and leaving when it had 200+. These days I'm a Senior Design
            Engineer at Buildout, making the design system and the interfaces it
            powers.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.32}>
          <ul className="skills-inline" aria-label="Skills">
            {SKILLS.map((s) => (
              <li key={s}>
                <span className="skills-marker" aria-hidden="true">
                  //
                </span>
                {s}
              </li>
